 ...
 */
$config['site_title']                 = "viethop";    		// Site Title
$config['admin_email']                = "admin@gmail.com"; // Admin Email
...
$config['lockout_time']               = 6000;                 /* The number of seconds to lockout an account due to exceeded attempts You should not use a value below 600 (10 minute) */
