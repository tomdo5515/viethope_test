...
/*
|--------------------------------------------------------------------------
| REST API Key encryption
|--------------------------------------------------------------------------
|
| Custom header to specify the API Token
| Note: Custom headers with the X- prefix are deprecated as of
|
*/
$config['rest_encryption_key'] = "1234567891234567";
...
|
*/
$config['data_encryption_key'] = "asd4567VF123#@67";
...
|
*/
$config['rest_asekey_name'] = "X-AUTH-API";
