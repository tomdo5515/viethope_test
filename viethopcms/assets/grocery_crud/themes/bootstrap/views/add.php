<?php
	...
	$this->set_js_config($this->default_theme_path.'/bootstrap/js/datatables-add.js');
...
<div class="page-title">
  <div>
    <h1><i class="fa fa-plus" aria-hidden="true"></i> <?php echo $this->l('form_add'); ?> <?php echo addslashes($subject); ?></h1>
	...
	<?php echo form_open( $insert_url, 'method="post" id="crudForm" enctype="multipart/form-data"'); ?>
		...
		<div class='buttons-box'>
			<div class="form-group">
				<button id="form-button-save" type="button" class="btn btn-success"><i class="glyphicon glyphicon-floppy-save"></i> <?php echo $this->l('form_save'); ?></button>

				<?php 	if(!$this->unset_back_to_list) { ?>
					<button id="save-and-go-back-button" type="button" class="btn  btn-info"><i class="glyphicon glyphicon-floppy-saved"></i> <?php echo $this->l('form_save_and_go_back'); ?></button>
				<?php   } ?>
