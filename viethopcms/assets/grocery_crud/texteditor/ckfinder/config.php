...
// $config['licenseName'] = 'viethope.org';
// $config['licenseKey']  = '9Q3QD782N4F1APB8U6GMAK61JYJFR';
// $config['licenseName'] = 'new.viethope.org';
// $config['licenseKey']  = 'EN7NTU6A5B6XJ6R3EPX1K4JXGE1HB';
//$config['licenseName'] = 'cicore.local';
//$config['licenseKey']  = 'JR3RJCYF3311S4AF5T81ZN8EY4HAL';
$config['licenseName'] = 'thuetoi.net';
$config['licenseKey']  = 'P626UFVJ5W1RR6FHVVHSBVES2BUJN';
...
$config['thumbnails'] = array(
    'enabled'      => true,
    'sizes'        => array(
        array('width' => '200', 'height' => '200', 'quality' => 80),
    ),
    'bmpSupported' => true,
);
...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => '/uploads',
    // comment when use nginx server
    'root'         => '/home/thuetoi.net/public_html/assets/uploads', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
